...
<Project Type="Project" LVVersion="12008004">
	<Property Name="varPersistentID:{070F23E8-7BA1-4708-9D45-B39239EFCD7D}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Shooter.lvlib/Shooter Tolerance</Property>
	<Property Name="varPersistentID:{0D23AC41-E58A-4743-9F96-E60AB455C78D}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Shooter.lvlib/Tow2 Offset RPM</Property>
	<Property Name="varPersistentID:{149A5169-FC16-4FAC-A570-D52ECC1BEAA9}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Elevator.lvlib/Auton Pitch</Property>
	<Property Name="varPersistentID:{1540A10B-2177-43E8-8BE9-D047B2E7BF71}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Ascent.lvlib/Slapper State</Property>
	<Property Name="varPersistentID:{1608E2A3-2D81-4DF8-A2AE-67BD04967307}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Sensors.lvlib/RightWheel Encoder</Property>
	<Property Name="varPersistentID:{18203026-0CF8-497D-B222-C988EE63D288}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Elevator.lvlib/Elev Loop</Property>
	<Property Name="varPersistentID:{18854B0B-5E75-4B67-939C-ADC16C9E8054}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Shooter.lvlib/Shooter Tolerance, Auton</Property>
	<Property Name="varPersistentID:{1A8AED22-F6BD-4357-9C4F-F23E11C0EDCD}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Operator.lvlib/Op Dpad (y)</Property>
	<Property Name="varPersistentID:{1F6CF8E6-A6FD-4BA7-90CB-644162FCB861}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Operator.lvlib/Op Ljoy (x)</Property>
	<Property Name="varPersistentID:{22AC4876-F62C-4FCC-B228-35C391DAE435}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Driver.lvlib/Dr Button 1</Property>
	<Property Name="varPersistentID:{22C0FEB8-BA99-4079-B716-DE2B72C29825}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Operator.lvlib/Op Button 7</Property>
	<Property Name="varPersistentID:{24EB3BD3-176E-4F39-94B6-AE836F3A97D3}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Ascent.lvlib/Climb Mode</Property>
	<Property Name="varPersistentID:{25E1DE6F-1732-44F9-9E61-17EFE83B11B2}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Driver.lvlib/Dr Ljoy (x)</Property>
	<Property Name="varPersistentID:{26A61C93-9447-4A47-AC89-A625C8B5C7D2}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Shooter.lvlib/Shooter RPM Response</Property>
	<Property Name="varPersistentID:{28119990-DCAB-4F21-A6DF-924189490981}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Operator.lvlib/Op Ljoy (y)</Property>
	<Property Name="varPersistentID:{2A690E3B-2F0C-4FA5-A105-0D4375257111}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Sensors.lvlib/Right Odo</Property>
	<Property Name="varPersistentID:{2A9D3F5A-A519-48E0-9039-B6038E647E8E}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/System.lvlib/Robot Mode</Property>
	<Property Name="varPersistentID:{31D649A9-F730-45ED-9873-AAE57137D5B3}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Elevator.lvlib/Elevator Stable</Property>
	<Property Name="varPersistentID:{33C2DDFB-FDC9-4CC3-A495-7B940E20B90D}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Operator.lvlib/Op Button 2</Property>
	<Property Name="varPersistentID:{3542C5C4-DC58-40AB-B25D-CEEC02EBBF9A}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Operator.lvlib/Op Dpad (x)</Property>
	<Property Name="varPersistentID:{3C1CC77A-A574-4357-ADCA-65F4D5F5EB3F}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Elevator.lvlib/Climb Pitch Enable</Property>
	<Property Name="varPersistentID:{3CF6BB23-69F7-446C-B394-131AA6499D31}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Operator.lvlib/Op Rjoy (x)</Property>
	<Property Name="varPersistentID:{40497263-2C11-4E07-9C16-B930EAC4EF18}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/System.lvlib/Data Log</Property>
	<Property Name="varPersistentID:{49F66B4D-9300-4E51-B7FB-DD059E8D53C2}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Elevator.lvlib/Elevator Response</Property>
	<Property Name="varPersistentID:{4C7E307D-A781-4611-9DFD-47961C9260C1}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Shooter.lvlib/Std RPM</Property>
	<Property Name="varPersistentID:{4CF5CAFF-CCA1-4600-A006-46F6712E757B}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Driver.lvlib/Dr Button 7</Property>
	<Property Name="varPersistentID:{4E89B268-A802-448B-AB4A-2EA03EBFA612}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Sensors.lvlib/BreakBeam OnDeck</Property>
	<Property Name="varPersistentID:{50B3BCC8-4011-4AA1-9D02-BD2366615838}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Drive.lvlib/Left X Drive</Property>
	<Property Name="varPersistentID:{542B9AA8-98F7-472B-A472-C685956EE8AD}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Elevator.lvlib/Wing Pitch</Property>
	<Property Name="varPersistentID:{5A0C669F-CB76-4AE7-A059-FA093586B0DF}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Driver.lvlib/Dr Button 11</Property>
	<Property Name="varPersistentID:{5A80394B-8553-40BE-9D45-898A251D1656}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Operator.lvlib/Op Button 4</Property>
	<Property Name="varPersistentID:{5C617B91-8486-43D5-AFFB-4F9EA0A7545B}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/System.lvlib/DEMO</Property>
	<Property Name="varPersistentID:{5DDD5223-C6E5-4A7D-A932-755D2EDE8887}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Operator.lvlib/Op Button 10</Property>
	<Property Name="varPersistentID:{60C4783C-22AB-4D95-8CD3-208932D97545}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Ascent.lvlib/Climb Step</Property>
	<Property Name="varPersistentID:{62F44605-28C2-445F-BA87-7C5EEA30B17C}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Driver.lvlib/Dr Rjoy (x)</Property>
	<Property Name="varPersistentID:{674CB176-09B3-4D8B-8528-74D73FAFE501}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Elevator.lvlib/Tow2 Offset Pitch</Property>
	<Property Name="varPersistentID:{67A708F6-033B-40EC-B608-45FA378FD97C}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Driver.lvlib/Dr Dpad (x)</Property>
	<Property Name="varPersistentID:{6A4B1B36-6155-466B-AE67-E99B70AAAA7C}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Elevator.lvlib/Elevator Control</Property>
	<Property Name="varPersistentID:{6B549827-39FD-4268-A874-959DE62CD1BB}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Elevator.lvlib/CornerShot Pitch</Property>
	<Property Name="varPersistentID:{6BC49976-F3A2-4E46-90F0-555FB70C96DB}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Elevator.lvlib/Elevator Bump</Property>
	<Property Name="varPersistentID:{6D29A819-CC15-48D1-B8E7-D03B356F55E9}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Operator.lvlib/Op Button 11</Property>
	<Property Name="varPersistentID:{6D62743E-09CB-4340-A694-A5340E2ED5D9}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Driver.lvlib/Dr Button 6</Property>
	<Property Name="varPersistentID:{6ED640F6-E6E4-4EF7-B675-9483EC2959DC}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Shooter.lvlib/Shooter Stable</Property>
	<Property Name="varPersistentID:{709DBB75-FE63-4996-A8DD-98D3BAF12BCC}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Driver.lvlib/Dr Button 8</Property>
	<Property Name="varPersistentID:{79858749-B286-4318-9941-C22100748A65}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Driver.lvlib/Dr Dpad (y)</Property>
	<Property Name="varPersistentID:{7F67B864-8AA7-485C-9711-FE8A26DC3B69}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Shooter.lvlib/Shooter RPM Control</Property>
	<Property Name="varPersistentID:{8E72F2AC-AD71-4FA2-94B6-57474AE1DC00}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Operator.lvlib/Op Button 6</Property>
	<Property Name="varPersistentID:{9490AC00-64A5-4802-AA12-7BB863D32979}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Driver.lvlib/Dr Button 10</Property>
	<Property Name="varPersistentID:{95972E95-22EE-4B59-A5A9-46DF7C5C0402}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Driver.lvlib/Dr Button 5</Property>
	<Property Name="varPersistentID:{9C7EBA9F-EB83-40A8-AF24-39E18015BAA8}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Shooter.lvlib/Tow1 Offset RPM</Property>
	<Property Name="varPersistentID:{9DB81D7A-78C2-48DF-8F19-8EFCA1D2D14A}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Shooter.lvlib/Shooter Bump</Property>
	<Property Name="varPersistentID:{A0DA20E0-FBE1-4324-891E-BB71305BDC20}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Shooter.lvlib/Wing RPM</Property>
	<Property Name="varPersistentID:{A6527B87-C004-41CA-9563-F6E98789735E}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Sensors.lvlib/BreakBeam Prime</Property>
	<Property Name="varPersistentID:{A746535A-133D-4A57-BD52-1AE856D93937}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Sensors.lvlib/Left Odo</Property>
	<Property Name="varPersistentID:{AA4E30F3-A188-4D83-A1D0-BB4EC82A550D}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Driver.lvlib/Dr Button 2</Property>
	<Property Name="varPersistentID:{AB053193-D076-4935-9B84-3B49B9B1220B}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Shooter.lvlib/RPM Protect</Property>
	<Property Name="varPersistentID:{ABB71FD2-FDBF-4B57-82B0-7483916163B6}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Operator.lvlib/Op Button 12</Property>
	<Property Name="varPersistentID:{AD03B2D2-FC00-4850-948F-E9DAC143D70F}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Elevator.lvlib/Tow3 Offset Pitch</Property>
	<Property Name="varPersistentID:{B66A1E02-333F-46E8-86A9-E5B833261848}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Sensors.lvlib/AvgWheelEncoder</Property>
	<Property Name="varPersistentID:{BE71D781-D92E-416B-91A5-273089C37FF5}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Ascent.lvlib/Climb Started</Property>
	<Property Name="varPersistentID:{BEE8DD26-1287-4A19-AFD7-CFF3649CC133}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Driver.lvlib/Dr Ljoy (y)</Property>
	<Property Name="varPersistentID:{BEFA6AFB-A391-45BE-BE85-BB734306306F}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Driver.lvlib/Dr Button 3</Property>
	<Property Name="varPersistentID:{C10EDD1B-AFD1-459A-ADB4-AF8CAB8A43F2}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Operator.lvlib/Op Button 1</Property>
	<Property Name="varPersistentID:{C203248A-ABE4-4AB0-9016-37BF8D543A36}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Elevator.lvlib/Tow1 Offset Pitch</Property>
	<Property Name="varPersistentID:{C574F57E-D8AC-48C3-A14A-2067948DA892}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Operator.lvlib/Op Button 5</Property>
	<Property Name="varPersistentID:{CF42C604-A5BC-43AA-A3C9-5994E9FEF9E3}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Shooter.lvlib/Tow3 Offset RPM</Property>
	<Property Name="varPersistentID:{D436B946-AD23-4F38-9C16-DD74AD7663BD}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Shooter.lvlib/Auton RPM</Property>
	<Property Name="varPersistentID:{DC174D87-E6DD-4444-83FB-9F88707426DA}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Operator.lvlib/Op Button 8</Property>
	<Property Name="varPersistentID:{E0C9932B-30E3-479D-989E-915F3D7B02B1}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Driver.lvlib/Dr Button 9</Property>
	<Property Name="varPersistentID:{E6CCB5EC-4E37-48A2-8C7D-8499A2961A97}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Driver.lvlib/Dr Rjoy (y)</Property>
	<Property Name="varPersistentID:{E9704247-880B-4867-8017-BFDDE8B1272A}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Driver.lvlib/Dr Button 4</Property>
	<Property Name="varPersistentID:{ECFD431A-9E11-4736-9BD1-53B75CA59A9C}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Operator.lvlib/Op Button 3</Property>
	<Property Name="varPersistentID:{F0512D78-1B54-412C-9673-00676A8386A8}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Operator.lvlib/Op Button 9</Property>
	<Property Name="varPersistentID:{F182B1C1-3394-4175-BC84-8E6B18C07066}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Operator.lvlib/Op Rjoy (y)</Property>
	<Property Name="varPersistentID:{F1EE8550-04E0-4A7C-BF60-E7BFDE5F367F}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Elevator.lvlib/Std Pitch</Property>
	<Property Name="varPersistentID:{F5D4BC94-6164-45E4-B0C2-6957623E041B}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Sensors.lvlib/LeftWheelEncoder</Property>
	<Property Name="varPersistentID:{F8E6BAB7-CD02-4544-818D-C9154425ED55}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Drive.lvlib/Right Y Drive</Property>
	<Property Name="varPersistentID:{FDA4EF10-72C6-4579-A1D8-37DC1C29A520}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Ascent.lvlib/ChinUp State</Property>
	<Property Name="varPersistentID:{FDC2932B-7538-4CEB-901A-C8731CF47ABB}" Type="Ref">/RT CompactRIO Target/Shared Variables.lvlib/Gamepad Driver.lvlib/Dr Button 12</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="wiring_ref_2013.xls" Type="Document" URL="../wiring_ref_2013.xls"/>
		<Item Name="climb_mode.ctl" Type="VI" URL="../climb_mode.ctl"/>
...
KeepAliveTimeout 60
		...
		<Item Name="Support Code" Type="Folder">
			<Item Name="climb_step_state.ctl" Type="VI" URL="../climb_step_state.ctl"/>
			<Item Name="fire_step_state.ctl" Type="VI" URL="../fire_step_state.ctl"/>
			<Item Name="Control 1.ctl" Type="VI" URL="../Control 1.ctl"/>
			<Item Name="Basic Auton.vi" Type="VI" URL="../Basic Auton.vi"/>
			<Item Name="Bump Counter.vi" Type="VI" URL="../Bump Counter.vi"/>
			<Item Name="Cheesy_drive.vi" Type="VI" URL="../Cheesy_drive.vi"/>
			<Item Name="cRIO MAC.vi" Type="VI" URL="../cRIO MAC.vi"/>
			<Item Name="cRIO Vision.vi" Type="VI" URL="../cRIO Vision.vi"/>
			<Item Name="Elapsed Times.vi" Type="VI" URL="../Elapsed Times.vi"/>
			<Item Name="JK Latch.vi" Type="VI" URL="../JK Latch.vi"/>
			<Item Name="Latch.vi" Type="VI" URL="../Latch.vi"/>
			<Item Name="launcher.vi" Type="VI" URL="../launcher.vi"/>
			<Item Name="Pulse Stretch &amp; Delay.vi" Type="VI" URL="../Pulse Stretch &amp; Delay.vi"/>
			<Item Name="Ratchet Brake.vi" Type="VI" URL="../Ratchet Brake.vi"/>
			<Item Name="SimpleSetMotor.vi" Type="VI" URL="../SimpleSetMotor.vi"/>
			<Item Name="Sine Scale.vi" Type="VI" URL="../Sine Scale.vi"/>
			<Item Name="Soft Stops.vi" Type="VI" URL="../Soft Stops.vi"/>
			<Item Name="Stable.vi" Type="VI" URL="../Stable.vi"/>
			<Item Name="Stable Rise&amp;Fall.vi" Type="VI" URL="../Stable Rise&amp;Fall.vi"/>
			<Item Name="tbh.vi" Type="VI" URL="../tbh.vi"/>
			<Item Name="Velocity Profile.vi" Type="VI" URL="../Velocity Profile.vi"/>
		</Item>
		<Item Name="Fire Control Loop.vi" Type="VI" URL="../Fire Control Loop.vi"/>
		<Item Name="Fifo Read Bool Array.vi" Type="VI" URL="../Fifo Read Bool Array.vi"/>
		<Item Name="Fifo Read Dbl Array.vi" Type="VI" URL="../Fifo Read Dbl Array.vi"/>
		<Item Name="Shared Variables.lvlib" Type="Library" URL="../Shared Variables.lvlib"/>
		<Item Name="Shooter Loop.vi" Type="VI" URL="../Shooter Loop.vi"/>
		<Item Name="Elevator Loop.vi" Type="VI" URL="../Elevator Loop.vi"/>
		<Item Name="Drive Loop.vi" Type="VI" URL="../Drive Loop.vi"/>
		<Item Name="Climb Loop.vi" Type="VI" URL="../Climb Loop.vi"/>
		<Item Name="Fire Data Logger.vi" Type="VI" URL="../Fire Data Logger.vi"/>
		<Item Name="Auto Ascent Data Logger.vi" Type="VI" URL="../Auto Ascent Data Logger.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="DEMO Lock.vi" Type="VI" URL="../DEMO Lock.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="RTExe_localDestPath" Type="Path">/C/Users/R/Documents/LabVIEW Data/port/Builds</Property>
				<Property Name="RTExe_localDestPathType" Type="Str">&lt;none&gt;</Property>
				<Property Name="Source[0].itemID" Type="Str">{2C5C351D-FD47-4407-B5C1-E0F68A27C1C9}</Property>
