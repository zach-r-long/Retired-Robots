...
KeepAliveTimeout 60
		...
		<Item Name="TypeDefs" Type="Folder">
			<Item Name="hiPri Dashboard Datatype.ctl" Type="VI" URL="../hiPri Dashboard Datatype.ctl"/>
		...
		<Item Name="Team Code" Type="Folder">
			...
			<Item Name="Ball Collector SM 5.1.vi" Type="VI" URL="../Ball Collector SM 5.1.vi"/>
			<Item Name="Periodic Tasks.vi" Type="VI" URL="../Periodic Tasks.vi"/>
			<Item Name="Build DashBoard Data.vi" Type="VI" URL="../Build DashBoard Data.vi"/>
			<Item Name="Robot Global Data.vi" Type="VI" URL="../Robot Global Data.vi"/>
			<Item Name="Finish.vi" Type="VI" URL="../Finish.vi"/>
			<Item Name="Bridge Balance State Machine.vi" Type="VI" URL="../Bridge Balance State Machine.vi"/>
			<Item Name="launcher.vi" Type="VI" URL="../launcher.vi"/>
			<Item Name="turret.vi" Type="VI" URL="../turret.vi"/>
			<Item Name="ball speed.vi" Type="VI" URL="../ball speed.vi"/>
			<Item Name="breakBeam.vi" Type="VI" URL="../breakBeam.vi"/>
			<Item Name="Latch Boolean.vi" Type="VI" URL="../Latch Boolean.vi"/>
			<Item Name="836Robot Global Data.vi" Type="VI" URL="../836Robot Global Data.vi"/>
			<Item Name="SimpleSetMotor.vi" Type="VI" URL="../SimpleSetMotor.vi"/>
		</Item>
		<Item Name="Support Code" Type="Folder">
			<Item Name="IMU" Type="Folder">
				<Item Name="Mag _Gain.ctl" Type="VI" URL="../IMU/Mag _Gain.ctl"/>
				<Item Name="Mag_Open.vi" Type="VI" URL="../IMU/Mag_Open.vi"/>
				<Item Name="Accel_Range.ctl" Type="VI" URL="../IMU/Accel_Range.ctl"/>
				<Item Name="Accel_Open.vi" Type="VI" URL="../IMU/Accel_Open.vi"/>
				<Item Name="Gyro_Sensitivity.ctl" Type="VI" URL="../IMU/Gyro_Sensitivity.ctl"/>
				<Item Name="Gyro_Open.vi" Type="VI" URL="../IMU/Gyro_Open.vi"/>
				<Item Name="Accel_ Axis.ctl" Type="VI" URL="../IMU/Accel_ Axis.ctl"/>
				<Item Name="Accel_Read.vi" Type="VI" URL="../IMU/Accel_Read.vi"/>
				<Item Name="Mag_Read .vi" Type="VI" URL="../IMU/Mag_Read .vi"/>
				<Item Name="Gyro_Read.vi" Type="VI" URL="../IMU/Gyro_Read.vi"/>
			</Item>
			<Item Name="836Elevator_Encoder.vi" Type="VI" URL="../836Elevator_Encoder.vi"/>
			...
			<Item Name="stateC.vi" Type="VI" URL="../stateC.vi"/>
			<Item Name="state2.vi" Type="VI" URL="../state2.vi"/>
		...
		<Item Name="turn(SubVI).vi" Type="VI" URL="../turn(SubVI).vi"/>
		<Item Name="drive straight auto.vi" Type="VI" URL="../drive straight auto.vi"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="RTExe_localDestPath" Type="Path">/C/Robobees/Builds</Property>
